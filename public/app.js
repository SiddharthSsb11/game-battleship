document.addEventListener("DOMContentLoaded", () => {
 ...
 // multiPlayerButton.addEventListener("click", startMultiPlayer);
  ...
  function startMultiPlayer() {
    ...
    socket.on("player-number", (num) => {
      if (num === -1) {
        ...
        //Get other player status//other than us//whether they are ready or not
    ...
    // Check player status // catching the same emit from the server
  ...
  //move around user ship, drag and drop
  ...
  function dragDrop() {
    ...
    console.log("shipclass taken form id slicing:", shipClass);
    let lastShipIndex = parseInt(shipNameWithLastId.substr(-1));
    let shipLastId = lastShipIndex + parseInt(this.dataset.id);
    console.log("last box number of the selected ship", shipLastId);

    //rightEdge //bottomedge cases
